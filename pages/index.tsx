  ...
  return (
    <div className="2xl:grid 2xl:grid-cols-2 2xl:grid-flow-row-dense">
      <div className='p-[16px] font-[Consolas,_"Courier_New",_monospace] 2xl:col-start-2'>
        <h2 className="text-[#abb2bf] mb-[16px] 2xl:text-center text-[20px] font-bold">
          Out Code
        </h2>
        {resultVals.map((it, key) => (
          <div key={key}>
            <button
              className={clsx(
                "bg-[#41454e] text-[#abb2bf] border-none [border:2px_solid_#1e1e1e] p-[8px_16px] font-bold text-[18px] cursor-pointer filter hover:brightness-110 active:enabled:brightness-90 transition-all duration-300",
            ...
            <p className="text-[#b5cea8] text-[18px] leading-[30px] mt-[16px]">
              <span className="text-[#abb2bf] font-bold">
                {it.className} Result Code:{" "}
              </span>
