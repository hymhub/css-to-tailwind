...
const propertyMap = new Map([
    ...
    [
        ...
        val => {
            ...
            const backdropFilterValConfig = {
                blur: (v) => `backdrop-blur-[${v}]`,
                brightness: (v) => `backdrop-brightness-[${v}]`,
                contrast: (v) => `contrast-[${v}]`,
                grayscale: (v) => `backdrop-grayscale-[${v}]`,
                'hue-rotate': (v) => {
                    const t = hasNegative(v);
                    return `${t[0]}backdrop-hue-rotate-[${t[1]}]`;
                },
                invert: (v) => `backdrop-invert-[${v}]`,
                opacity: (v) => `backdrop-opacity-[${v}]`,
                saturate: (v) => `backdrop-saturate-[${v}]`,
                sepia: (v) => `backdrop-sepia-[${v}]`
            };
    ...
    [
        ...
        val => {
            ...
            const vals = val.split(' ').filter(v => v !== '').map(v => { var _a, _b; return (isUnit(v) || isColor(v)) ? ((_a = { 'transparent': 'border-transparent', 'currentColor': 'border-current', 'currentcolor': 'border-current' }[val]) !== null && _a !== void 0 ? _a : `border-[${v}]`) : ((_b = propertyMap.get('border-style')[v]) !== null && _b !== void 0 ? _b : ''); }).filter(v => v !== '').join(' ');
            return vals;
        }
    ],
    [
    ...
    [
        ...
        val => { var _a; return ((_a = { '0': 'rounded-bl-none', '0px': 'rounded-bl-none' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `rounded-bl-[${getCustomVal(val)}]` : '')); }
    ],
    [
        'border-bottom-right-radius',
        val => { var _a; return ((_a = { '0': 'rounded-br-none', '0px': 'rounded-br-none' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `rounded-br-[${getCustomVal(val)}]` : '')); }
    ],
    [
        'border-bottom-style',
    ...
    [
        ...
        val => { var _a; return ((_a = { '0': 'rounded-tl-none', '0px': 'rounded-tl-none' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `rounded-tl-[${getCustomVal(val)}]` : '')); }
    ],
    [
        'border-top-right-radius',
        val => { var _a; return ((_a = { '0': 'rounded-tr-none', '0px': 'rounded-tr-none' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `rounded-tr-[${getCustomVal(val)}]` : '')); }
    ],
    [
        'border-top-style',
    ...
    [
        ...
        val => {
            var _a;
            const t = hasNegative(val);
            return (_a = { '0': 'mb-0', '0px': 'mb-0', 'auto': 'mb-auto' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `${t[0]}mb-[${t[1]}]` : '');
        }
    ],
    [
        'margin-left',
        val => {
            var _a;
            const t = hasNegative(val);
            return (_a = { '0': 'ml-0', '0px': 'ml-0', 'auto': 'ml-auto' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `${t[0]}ml-[${t[1]}]` : '');
        }
    ],
    [
        'margin-right',
        val => {
            var _a;
            const t = hasNegative(val);
            return (_a = { '0': 'mr-0', '0px': 'mr-0', 'auto': 'mr-auto' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `${t[0]}mr-[${t[1]}]` : '');
        }
    ],
    [
        'margin-top',
        val => {
            var _a;
            const t = hasNegative(val);
            return (_a = { '0': 'mt-0', '0px': 'mt-0', 'auto': 'mt-auto' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `${t[0]}mt-[${t[1]}]` : '');
        }
    ],
    [
        'mask',
    ...
    [
        'padding-bottom',
        val => { var _a; return ((_a = { '0': 'pb-0', '0px': 'pb-0' }[val]) !== null && _a !== void 0 ? _a : ((isUnit(val) ? `pb-[${val}]` : ''))); }
    ],
    [
        'padding-left',
        val => { var _a; return ((_a = { '0': 'pl-0', '0px': 'pl-0' }[val]) !== null && _a !== void 0 ? _a : ((isUnit(val) ? `pl-[${val}]` : ''))); }
    ],
    [
        'padding-right',
        val => { var _a; return ((_a = { '0': 'pr-0', '0px': 'pr-0' }[val]) !== null && _a !== void 0 ? _a : ((isUnit(val) ? `pr-[${val}]` : ''))); }
    ],
    [
        'padding-top',
        val => { var _a; return ((_a = { '0': 'pt-0', '0px': 'pt-0' }[val]) !== null && _a !== void 0 ? _a : ((isUnit(val) ? `pt-[${val}]` : ''))); }
    ],
    [
        'page-break-after',
        {
...
const getResultCode = (it, prefix = '') => {
    ...
    const resultVals = cssCodeList.map(v => {
        ...
        if (val === 'initial' || val === 'inherit') {
            ...
            pipeVal = typeof pipe === 'function' ? pipe(val) : ((_a = pipe === null || pipe === void 0 ? void 0 : pipe[val]) !== null && _a !== void 0 ? _a : '');
        }
        if (hasImportant) {
...
export const CssToTailwindTranslator = (code) => {
